    ...
    ngOnChanges() {
        ...
        if (this.isNative && data.unified && data.native) {
            ...
            if (data.hidden.length && data.hidden.includes(this.set)) {
                ...
                this.style = this.emojiService.emojiSpriteStyles(data.sheet, this.set, this.size, this.sheetSize, this.sheetRows, this.backgroundImageFn, this.sheetColumns);
            }
        }
